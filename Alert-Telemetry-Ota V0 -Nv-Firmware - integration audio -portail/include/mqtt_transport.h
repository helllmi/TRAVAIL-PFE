 ...
 * ===========================================================================
 *  Le code métier (main, FSM, storage flush) appelle ces fonctions
 *  sans savoir si le transport est WiFi ou LTE.
 *  Le routage se fait à la COMPILATION via #if MQTT_TRANSPORT.
 *
 *  Bascule : modifier MQTT_TRANSPORT dans config.h, recompiler.
 * ===========================================================================
 */
